...
daves_last_lesson = UserLesson.create(completed: false, user: dave, lesson: lesson_one)
janes_last_lesson = UserLesson.create(completed: false, user: jane, lesson: lesson_two)
